...
function Logo() {
  return (
    ...
    >
      <span>Live Era</span>
      <span
        className="inline-block transition-[transform,color] duration-[2000ms] ease-slow group-hover:-translate-y-1 group-hover:text-gold motion-reduce:transition-none motion-reduce:group-hover:translate-y-0"
      >
        2
      </span>
      <span
