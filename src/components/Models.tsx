    ...
    <section className="border-b border-rule">
      <div className="mx-auto max-w-[1440px] px-8 py-12 lg:px-16">
        ...
        <p className="type-body mt-4 max-w-[820px]">
          Kling держит мимику и умеет 4K, Hedra заставляет портрет говорить, Motion Control
          переносит движение с вашего видео, Veo добавляет звук, а Grok делает ролик дешевле всех.
          В сценариях модель подбирается под задачу сама, в прямом
