...
const PACKS: Pack[] = [
  {
    ...
    items: [
      ...BASE("115", "≈ 9 роликов, или 3 на KLING 3.0"),
  ...
  },
  {
    ...
    featured: true,
    items: [
      ...BASE("260", "≈ 21 ролик, или 8 на KLING 3.0"),
  ...
  },
  {
    ...
    items: [
      ...BASE("760", "≈ 63 ролика, или 24 на KLING 3.0"),
      { text: "Несколько снимков в одной сцене" },
      { text: "Качество 4K" },
      { text: "Без автоматических списаний" },
      { text: "Без водяных знаков" },
  ...
  },
  {
    ...
    items: [
      ...BASE("1 700", "≈ 141 ролик, или 54 на KLING 3.0"),
      { text: "Несколько снимков в одной сцене" },
      { text: "Качество 4K" },
      { text: "Без автоматических списаний" },
      { text: "Без водяных знаков" },
