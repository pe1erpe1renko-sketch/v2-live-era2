    ...
    <section className="border-t border-rule">
      <div className="mx-auto max-w-[1440px] px-8 pt-16 lg:px-16">
        ...
        <p className="mt-4 text-[13px] leading-[1.6] text-ink3">
          Ролик на 10 секунд расходует вдвое больше — кроме Veo и Hailuo, у них цена за ролик не
          зависит от длины. У Hedra длительность задаёт звуковая дорожка. У Kling 3.0 Motion Control
          длительность задаёт видео-эталон: сколько секунд в нём, столько и в готовом ролике. Звук
          эта модель берёт оттуда же, отдельной доплаты за него нет. Звук и разрешение выше
          базового считаются по отдельной ставке. Если генерация сорвалась, токены возвращаются
          автоматически.
        </p>
      </div>
    </section>
