...
const FAQ = [
  ...
  },
  {
    ...
    a: "Зависит от модели. Hailuo 2 расходует двенадцать токенов на пятисекундный ролик, KLING 3.0 — тридцать один, Seedance 2.0 — восемьдесят три, зато держит детали точнее. Из 260 токенов тарифа «Про» выходит около двадцати одного ролика на экономной модели или восьми на KLING.",
  },
  {
